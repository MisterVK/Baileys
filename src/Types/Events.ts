...
export type BaileysEventMap = {
    ...
    'label.edit': Label
    'label.association.add': {associationId: string, labelId: string, type: LabelAssociationType}
    'label.association.delete': {associationId: string, labelId: string, type: LabelAssociationType}
}
